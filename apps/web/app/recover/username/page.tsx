...
export default function RecoverUsernameByQuestionsPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      await apiFetch("/auth/recover/username", {
        method: "POST",
        body: JSON.stringify({
          login,
          answers: [
      ...
      setSuccess("If your answers match an account, we’ll email your username shortly.");
      setLogin("");
      setA1("");
      setA2("");
      setA3("");
  ...
  return (
    <div className="mx-auto max-w-xl">
      <Card>
        <h1 className="text-xl font-semibold">Recover username</h1>
        <p className="mt-1 text-sm text-[color:var(--muted)]">Answer your security questions to request a username reminder email.</p>
